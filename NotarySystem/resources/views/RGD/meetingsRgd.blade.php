@extends('layouts.meetingRgdLayout')
<head>
...
<div class="col-1">
  <div class="container">
    <a class="btn btn-info btn-lg" href="/rgd"><i class="fa fa-home hvr-icon"></i> Back</a>   
  </div>
</div>
</div>
...
<div class="panel panel-primary" style="width: 93%;margin-left:1.4%;">
