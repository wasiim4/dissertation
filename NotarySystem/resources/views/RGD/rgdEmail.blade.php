                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                            ...
                            <select name="inputRecipient" id="inputRecipient" class="form-control input-lg dynamic" >
                                    ...
                                    <option value="{{ $bank->id}}">{{$bank->id}}<?php echo"-"?>{{$bank->name}}<?php echo"-"?>{{$bank->branch}}<?php echo"-"?>{{$bank->roles}}</option>
                                    @endforeach
                                    @foreach($landSurveyors as $landSurveyor)
                                    <option value="{{$landSurveyor->id}}">{{$landSurveyor->id}}<?php echo"-"?>{{$landSurveyor->name}}<?php echo"-"?>{{$landSurveyor->roles}}</option>
                                     @endforeach
                               </select>                       
                            </div>
