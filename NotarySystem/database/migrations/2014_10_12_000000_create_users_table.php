...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->enum('spouseBCdistrictIssued', ['Port Louis','Moka','Plaine Wilhems','Pamplemousses','Grand Port','Savanne','Flacq','Rivière du Rempart','Rivière Noire'])->default("Port Louis")->nullable();
            $table->string('spousePlaceOfBirth')->nullable();
            $table->enum('spouseGender', ['Male','Female'])->default("Male")->nullable();
            $table->string('spouseNic')->unique()->nullable();
            $table->date('marriageDate')->nullable();
            $table->integer('MCNumber')->unique()->nullable();
            $table->enum('MCdistrictIssued', ['Port Louis','Moka','Plaine Wilhems','Pamplemousses','Grand Port','Savanne','Flacq','Rivière du Rempart','Ri->nullabvière Noire'])->default("Port Louis")->nullable();
            ...
            $table->enum('DCdistrictIssued', ['Port Louis','Moka','Plaine Wilhems','Pamplemousses','Grand Port','Savanne','Flacq','Rivière du Rempart','Ri->nullabvière Noire'])->default("Port Louis")->nullable();
            $table->integer('DivCNum')->unique()->nullable();
            $table->date('DivDate')->nullable();
            $table->enum('DivCdistrictIssued', ['Port Louis','Moka','Plaine Wilhems','Pamplemousses','Grand Port','Savanne','Flacq','Rivière du Rempart','Ri->nullabvière Noire'])->default("Port Louis")->nullable();
            $table->rememberToken();
        ...
        Schema::create('land_surveyors', function (Blueprint $table) {
            $table->increments('id');
           // $table->enum('title', ['Monsieur','Madame','Mademoiselle'])->default("Monsieur");
            $table->enum('roles', ['Land Surveyor'])->default("Land Surveyor");
            $table->string('name');
            //$table->string('lastname');
            $table->string('email')->unique();
            $table->string('password');
        ...
        Schema::create('banks', function (Blueprint $table) {
            $table->increments('id');
           // $table->enum('title', ['Monsieur','Madame','Mademoiselle'])->default("Monsieur");
            $table->enum('roles', ['BANK'])->default("BANK");
            $table->string('name');
            $table->string('branch');
            //$table->string('lastname');
            $table->string('email')->unique();
