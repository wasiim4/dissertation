...
<?php $__env->startSection('content'); ?>
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('staff.login.submit')); ?>" aria-label="<?php echo e(__('Login')); ?>">
                        <?php echo csrf_field(); ?>

                        <div class="form-group row">
                            <label for="email" class="col-sm-4 col-form-label text-md-right"><?php echo e(__('Staff E-Mail Address')); ?></label>
                            <br>
